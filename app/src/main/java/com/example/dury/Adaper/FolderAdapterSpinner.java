...
public class FolderAdapterSpinner extends ArrayAdapter<FolderModel_ver2> {

    private LayoutInflater mInflater;
    private int mResource;

    public FolderAdapterSpinner(Context context, List<FolderModel_ver2> folders, int resource) {
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent) {
        ...
        if (folder != null) {
            holder.textView.setText(folder.getFolderName());
        }
